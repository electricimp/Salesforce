...
- An imp001 card, which contains a WiFi radio and the microcontroller that drives all the logic for the board
...
![An Electric Imp Application: the device, running device code, connects to its agent in the impCloud. The agent, running agent code, is the device's front end to the Internet, and communicates with external resources such as the Salesforce Cloud](png/0_2.jpg "An Electric Imp Application: the device, running device code, connects to its agent in the impCloud. The agent, running agent code, is the device's front end to the Internet, and communicates with external resources such as the Salesforce Cloud")
...
1. Click on the **Create a Product** button:
![Click on the Create a Product button in impCentral](png/202.png "Click on the Create a Product button in impCentral")
1. In the pop up, enter a Product name (eg. **SmartFridge**), an Application Workspace name (eg. **SmartFridge**), and then click the **Create** button:
![Enter a Product name and the name of an Application Workspace in the Create Product pop up](png/202.png "Enter a Product name and the name of an Application Workspace in the Create Product pop up")<br>A Product defines a new connected product in the Electric Imp impCloud. An Application Workspace is the place where you develop and test your application software, both the device code and the agent code
...
1. Click on the **Assign Devices** link:
...
1. In the **Assign Devices** pop up, choose your impExplorer by locating its device ID, and click **Assign**:
![Select your impExplorer and click Assign in the Assign Devices pop up](png/204.png "Select your impExplorer and click Assign in the Assign Devices pop up")
1. At the top of the logs pane you can find agent URL of your device. It will look something like this: ```"https://agent.electricimp.com/szPc0sLfAqlu"```
...
1. Click on the **Setup** icon in the top-right navigation menu and select **Setup**:
...
![Select Setup from the top-right gearwheel icon](png/1_1.png "Select Setup from the top-right gearwheel icon")
1. Click on the **Object Manager** tab next to **Home**:
...
1. Click on the **Create** drop-down and then select **Custom Object**:
...
1. Insert the following code into the space provided (see the image below):
```
...
1. On the Salesforce page, click the **Setup** icon in the top-right navigation menu and select **Setup**:
![Select Setup from the top-right gearwheel icon](png/1_1.png "Select Setup from the top-right gearwheel icon")
1. Enter **Contexts** into the **Quick Find** box and then select **Feature Settings > IoT Explorer > Contexts**:
...
![Select Setup from the top-right gearwheel icon](png/1_1.png "Select Setup from the top-right gearwheel icon")
1. Click on **Object Manager** tab next to **Home**:
1. Click on the **Object Manager** tab next to **Home**:
![On the Salesforce navigation bar, click on the Object Manager tab](png/5_1.png "On the Salesforce navigation bar, click on the Object Manager tab")
...
2. The temperature rises above 11&deg;C, or
...
1. On the Salesforce page, click the **Setup** icon in the top-right navigation menu and select **Setup**:
![Select Setup from the top-right gearwheel icon](png/1_1.png "Select Setup from the top-right gearwheel icon")
1. Enter **Orchestrations** into the **Quick Find** box and then select **Feature Settings > IoT Explorer > Orchestrations**:
...
1. Click on the **VARIABLES** tab. Now you can to set up temperature and humidity thresholds, and a door opening counter and limit
...
1. Click on the **GLOBAL RULES** tab.
...
1. Click on the **STATES** tab. Make sure that your States diagram looks like this:
...
1. In the **Activating Orchestration** pop up, click **Activate**:
![Click on the Activate button then click on the Activate button in the Activating Orchestration pop up](png/50.png "Click on the Activate button then click on the Activate button in the Activating Orchestration pop up")
1. Do not close Salesforce page
...
You can use the Salesforce1 mobile app to see the data which your device sends. To do this, you need to perform the following tasks:
...
1. Click the **Setup** icon in the top -right navigation menu and select **Setup**:
![Select Setup from the top-right gearwheel icon](png/1_1.png "Select Setup from the top-right gearwheel icon")
1. Enter **Tabs** into the **Quick Find** box and then select **User Interface > Tabs**
...
1. Click the **Setup** icon in the top-right navigation menu and select **Setup**:
![Select Setup from the top-right gearwheel icon](png/1_1.png "Select Setup from the top-right gearwheel icon")
1. Enter **Salesforce1** into the **Quick Find** box and then select **Apps > Mobili Apps > Salesforce1 > Salesforce1 Settings**
...
1. Enter **Users** in the **Quick Find** box and select **Users > Users**
...
1. Append `/one/one.app` to the end of the URL after salesforce.com. For example:
![The correct URL](png/97.png "The correct URL")
1. Press Enter. Salesforce1 emulation will be started in the Chrome Browser. If the display is too small, change the size to 100%:<br>
...
1. Select a record to view the details of the reading:
...
You can now see transitions between the states which you defined in the IoT Explorer Orchestration section, as well as registered Cases.

1. On the Salesforce page, click the **Setup** icon in the top-right navigation menu and select **Setup**:
![Select Setup from the top-right gearwheel icon](png/1_1.png "Select Setup from the top-right gearwheel icon")
1. Enter **Orchestrations** into the **Quick Find** box and then select **Feature Settings > IoT Explorer > Orchestrations**:
![Key Orchestrations into the Quick Find box and then click on Feature Settings, IoT Explorer and Orchestrations](png/24.png "Key Orchestrations into the Quick Find box and then click on Feature Settings, IoT Explorer and Orchestrations")
1. Click on **Smart Fridge Orchestration**
...
1. Click on the hamburger menu in the upper left to open the navigation panel
